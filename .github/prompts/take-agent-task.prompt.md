---
description: "Take and implement one scoped SectorForge docs/agent-tasks.md task end to end with code, docs, tests, and validation."
...
1. Read `AGENTS.md`, `README.md`, `CONTRIBUTING.md`, and the task entry.
